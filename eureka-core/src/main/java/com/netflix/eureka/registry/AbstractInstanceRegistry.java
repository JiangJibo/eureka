...
public abstract class AbstractInstanceRegistry implements InstanceRegistry {
    ...
    @com.netflix.servo.annotations.Monitor(name = "numOfElementsinInstanceCache", description = "Number of overrides in the instance Cache",
